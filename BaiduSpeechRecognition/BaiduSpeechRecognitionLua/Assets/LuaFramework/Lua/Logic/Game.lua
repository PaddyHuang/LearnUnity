...
require "Controller/RecognisePanelCtrl"
...
function Game.OnInitOK()
    ...
    CtrlManager.Init()
    local ctrl = CtrlManager.GetCtrl(CtrlNames.Recognise)
...
function Game.GetToken()
	...
	data:AddField('client_id', UserInfo.API_KEY)
	data:AddField('client_secret', UserInfo.SECRECT_KEY)
	
	if string.len(UserInfo.TOKEN) == 0 then
		local www = WWW(Url, data)
		coroutine.www(www)
		-- print(www.text)
...
function Game.OnJsonCall(data)
	...
	UserInfo.TOKEN = obj["access_token"]
