layui.config({
    ...
    var editDlg = function () {
        ...
        var show = function (data) {
            ...
            layer.open({
                ...
                area: ["98%", "98%"],
                type: 2,
                content: /*$('#divEdit')*/update ? common.renderUrl('/DisplayModule/Update', {
                    id: data.Id
                }) : common.renderUrl('/DisplayModule/Add', {
                    id: data.Id
                }),
                //success: function () {
                //    //vm.$set('$data', data);
    ...
    var meditDlg = function () {
        ...
        var show = function (data) {
            ...
            var url = "/DisplayModule/AddMenu";
            if (update) {
                url = "/DisplayModule/UpdateMenu";
            }
            //提交数据
    ...
    var active = {
        btnDel: function () {      //删除模块
            ...
            openauth.del("/NewsManager/Delete",
        ...
        , btnDelMenu: function () {      //删除菜单
            var checkStatus = table.checkStatus('menuList')
                , data = checkStatus.data;
            openauth.del("/NewsManager/DelMenu",
                data.map(function (e) { return e.Id; }),
                menuList);
        }
