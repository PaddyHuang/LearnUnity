layui.config({
    ...
    var editDlg = function () {
        ...
        var show = function (data) {
            ...
            layer.open({
                ...
                area: ["98%", "98%"],
                type: 2,
                content: /*$('#divEdit')*/update ? common.renderUrl('/ProcessItem/Update', {
                    id: data.Id
                }) : common.renderUrl('/ProcessItem/Add', {
                    id: data.Id
                }),
                //success: function () {
                //    //vm.$set('$data', data);
    ...
    var active = {
        btnDel: function () {      //删除模块
            ...
            openauth.del("/ProcessItem/Delete",
        ...
        , btnDelMenu: function () {      //删除菜单
            var checkStatus = table.checkStatus('menuList')
                , data = checkStatus.data;
            openauth.del("/ProcessItem/DelMenu",
                data.map(function (e) { return e.Id; }),
                menuList);
        }
