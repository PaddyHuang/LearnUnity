...
jQuery.validator.addMethod("loginCode", function (value, element) {
    var fmt = /^[a-zA-Z0-9]{2,10}$/;
    var tp = this.optional(element) || fmt.test(value);
    return tp;
}, "登录帐号格式错误");
