...
namespace OpenAuth.App.SSO
{
    ...
    public class AuthUtil
    {
        ...
        public static bool CheckLogin(string token, string remark = "")
        {
            ...
            var requestUri = String.Format("/Check/GetStatus?token={0}&requestid={1}", token, remark);
        ...
        public static UserWithAccessedCtrls GetCurrentUser(string remark = "")
        {
            ...
            var requestUri = String.Format("/Check/GetUser?token={0}&requestid={1}", GetToken(), remark);
        ...
        {
            var requestUri = String.Format("/Check/GetUserName?token={0}&requestid={1}", GetToken(), remark);
        ...
        public static bool Logout()
        {
            ...
            var requestUri = String.Format("/Check/Logout?token={0}&requestid={1}", token, "");
