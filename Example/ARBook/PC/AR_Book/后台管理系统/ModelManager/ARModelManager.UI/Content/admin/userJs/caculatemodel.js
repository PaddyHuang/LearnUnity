    ...
    var editDlg = function () {
        ...
        var show = function (data) {
            ...
            layer.open({
                ...
                area: ["98%", "98%"],
                type: 2,
                content: /*$('#divEdit')*/update ? common.renderUrl('/TypeCalculation/Update', {
                    id: data.Id
                }) : common.renderUrl('/TypeCalculation/Add', {
                    id: data.Id
                }),
                //success: function () {
                //    //vm.$set('$data', data);
