...
layui.define(['layer', 'laypage', 'laytpl'], function (exports) {
    ...
    Paging.prototype.get = function (options) {
        ...
        console.log(JSON.stringify(_config.params));
              ...
              //  console.log(JSON.stringify(result));
                ...
                if (result.Code == 0) {
                    ...
                    if (_config.paged) {
                       ...
                       // $.extend(pageoption, _pageConfig); //参数合并
                        console.log(JSON.stringify(pageoption))
                        laypage.render(pageoption); //调用laypage组件渲染分页
                    }
                    if (_config.success) {
